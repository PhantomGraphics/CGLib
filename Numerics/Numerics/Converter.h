...
/**
 * @brief Bidirectional converter between Crystal math types and Eigen types.
 *
 * Crystal uses its own Math::Matrix/Vector classes (suffix `dd` = double precision),
 ...
 *
 * ## Index convention
 * Crystal matrices use `[row][col]` (operator[]) while Eigen uses `(row, col)`.
...
{
public:
	/** @brief Convert a 2x2 double-precision Crystal matrix to an Eigen matrix. */
	static Eigen::Matrix2d toEigen(const Math::Matrix2dd& src);

	/** @brief Convert a 3x3 double-precision Crystal matrix to an Eigen matrix. */
	static Eigen::Matrix3d toEigen(const Math::Matrix3dd& src);

	/** @brief Convert a 4x4 double-precision Crystal matrix to an Eigen matrix. */
	static Eigen::Matrix4d toEigen(const Math::Matrix4dd& src);

	/** @brief Convert a 2-component Crystal vector to an Eigen column vector. */
	static Eigen::Vector2d toEigen(const Math::Vector2dd& src);

	/** @brief Convert a 3-component Crystal vector to an Eigen column vector. */
	static Eigen::Vector3d toEigen(const Math::Vector3dd& src);

	/** @brief Convert a 4-component Crystal vector to an Eigen column vector. */
	static Eigen::Vector4d toEigen(const Math::Vector4dd& src);

	/** @brief Convert a 2x2 Eigen matrix to a Crystal matrix. */
	static Math::Matrix2dd fromEigen(const Eigen::Matrix2d& src);

	/** @brief Convert a 3x3 Eigen matrix to a Crystal matrix. */
	static Math::Matrix3dd fromEigen(const Eigen::Matrix3d& src);

	/** @brief Convert a 4x4 Eigen matrix to a Crystal matrix. */
	static Math::Matrix4dd fromEigen(const Eigen::Matrix4d& src);

	/** @brief Convert a 2-component Eigen vector to a Crystal vector. */
	static Math::Vector2dd fromEigen(const Eigen::Vector2d& src);

	/** @brief Convert a 3-component Eigen vector to a Crystal vector. */
	static Math::Vector3dd fromEigen(const Eigen::Vector3d& src);

	/** @brief Convert a 4-component Eigen vector to a Crystal vector. */
